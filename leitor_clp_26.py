...
class CustomCombinedHTTPRequestHandler(BaseHTTPRequestHandler):
    def log_message(self, format, *args):
        return  # Desabilita logs de requisição no console para melhor visibilidade
    ...
    def do_POST(self):
        global USAR_CLP_REAL, ESTADO_ENTRADAS, ESTADO_SAIDAS, VALOR_PRESSAO_BAR, POTENCIA_KW, DETALHAMENTO_POTENCIA, STATUS_COMUNICACAO
        
        # 1. Rota para alternar modo de simulação
        if self.path == "/toggle_modo":
    ...
    def do_GET(self):
        ...
        # 2. Rota de API JSON para o Front-end
        ...
        # 3. Servir arquivos estáticos (STL e Imagens)
