        ...
        if not USAR_CLP_REAL and STATUS_COMUNICACAO != "CLP_REAL_CONECTADO":
            ...
            try:
                ...
                with dados_lock:
                    ...
                    # NOVOS TEMPOS DAS SAÍDAS PARA MANTER OS EIXOS EM MOVIMENTO
                    ESTADO_SAIDAS["Y0"] = (segundos % 8) < 4   # Pulso/Hab. Eixo X (4s ON / 4s OFF)
                    ESTADO_SAIDAS["Y4"] = (segundos % 16) < 8  # Direção Eixo X
                    ESTADO_SAIDAS["Y1"] = (segundos % 12) < 6  # Avanço Eixo Y (6s ON dá tempo do curso completo)
                    ESTADO_SAIDAS["Y2"] = (segundos % 10) < 5  # Avanço Eixo Z (5s ON dá tempo do curso completo)
    
                    # Demais saídas genéricas
                    for i in [3, 5, 6, 7]:
                ...
                if EH_AMBIENTE_RENDER:
                    ...
                    if sem_comunicacao:
                        ...
                        for i in range(8):
                            ...
                            # Substitui o loop genérico de saídas pelos tempos estendidos
                            ESTADO_SAIDAS["Y0"] = (segundos % 8) < 4
                            ESTADO_SAIDAS["Y4"] = (segundos % 16) < 8
                            ESTADO_SAIDAS["Y1"] = (segundos % 12) < 6
                            ESTADO_SAIDAS["Y2"] = (segundos % 10) < 5
                            for i in [3, 5, 6, 7]:
                                ESTADO_SAIDAS[f"Y{i}"] = ((segundos + i) % 3) == 0
